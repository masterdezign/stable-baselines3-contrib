...
def sample_params(trial: optuna.Trial) -> dict:
    ...
    burn_in = trial.suggest_categorical("burn_in", [0, 4])
...
def run_study(
    ...
    study = optuna.create_study(
        ...
        sampler=sampler,
        pruner=pruner,
        study_name="rsac_lunarlander_no_vel_v2",
        storage=storage,
        load_if_exists=True,
    )
    study.optimize(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1_000_000,
        help="Training budget per trial (default: 1M)",
    )
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument(
        "--storage",
        type=str,
        default="sqlite:///lunarlander.db",
